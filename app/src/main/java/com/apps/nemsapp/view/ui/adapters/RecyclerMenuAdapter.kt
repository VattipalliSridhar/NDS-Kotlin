...
import com.apps.nemsapp.databinding.MenuAdapterBinding
...
class RecyclerMenuAdapter(
    ...
    inner class MyHolderClass(var menuAdapterBinding: MenuAdapterBinding) :
        RecyclerView.ViewHolder(menuAdapterBinding.root)
